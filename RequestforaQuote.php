...
<?php include "includes/header.php"; ?> 
    ...
    <section class="cardiologysection">
        <ul class="d-flex align-items-center">
            <li class="w-50">
                <div class="home-info-bg">
                    ...
                    <div class="home-detail">
                        ...
                        <h1 class="color-pink">REQUEST FOR A <br>
                            QUOTE/TREATMENT <br>
                            PLAN</h1>
            ...
            <li class="w-50">
                <span><img src="assets/images/requestquata.jpg" alt=""></span>
            </li>
        </ul>
            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    <div class="servicemaintitle">
                        <h3>Request for a Quote/Treatment Plan
                        </h3>
                            ...
                            <div class="form">
                                <form class="form-info" action="">
                                    ...
                                    <div class=" header-right">
                                        <button class="btn-submit" href="#"> <img src="./assets/images/metamase.svg"
                                                alt="">
                                            Submit
                                        </button>
                                    </div>
