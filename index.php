            ...
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill"
                        ...
                        aria-selected="true"><img src="<?php echo BASE_URL ?>assets/images/appoinmentimg1.avif" alt=""> Book
                        Appointment</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill"
                        data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile"
                        aria-selected="false"><img src="<?php echo BASE_URL ?>assets/images/appoinmentimg2.avif" alt=""> Virtual Second
                        Opinion</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill"
                        data-bs-target="#pills-contact" type="button" role="tab" aria-controls="pills-contact"
                        aria-selected="false"><img src="<?php echo BASE_URL ?>assets/images/appoinmentimg3.avif" alt=""> Health
                        Checkup</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pills-Maternity-tab" data-bs-toggle="pill"
                        ...
                        aria-selected="false"><img src="<?php echo BASE_URL ?>assets/images/appoinmentimg4.avif" alt=""> Maternity
                        Packages</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pills-homecare-tab" data-bs-toggle="pill"
                        data-bs-target="#pills-homecare" type="button" role="tab" aria-controls="pills-homecare"
                        aria-selected="false"><img src="<?php echo BASE_URL ?>assets/images/appoinmentimg5.avif" alt=""> Home Care</button>
                </li>
                <li class="nav-item" role="presentation">
            ...
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                    <div class="row">
                        ...
                        <div class="col-lg-5">
                            <div class="menu treatmentoption">
                                <ul>
                                    ...
                                    <li>
                                        <img src="<?php echo BASE_URL ?>assets/images/heart.avif" alt="View All">
                        ...
                        <div class="col-lg-4">
                            <div class="">
								<iframe width="100%" height="720" frameborder="0" scrolling="yes"  src="<?php echo APPOINTMENT_BASE_URL; ?>"></iframe>
							</div>
                            <!--<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">-->
                            <!--    <li class="nav-item" role="presentation">-->
    ...
    <section class="expertisesec">
        <div class="container">
            ...
            <div class="button-doctor">
                <a class="btn-submit" href="findyoutdoctors.php"> <img src="<?php echo BASE_URL ?>assets/images/find-icon.png" alt="">
                    Find a Doctor
                </a>
            </div>
        </div>
 ...
 <!--   <section class="rakhintegratedsec">
            ...
            <div class="row align-items-start">
                <div class="col-lg-5">
                    <div class="rakcaretitle">
                        ...
                        <p class="card-text">At RAK Hospital, care transcends mere treatment; it embodies compassion, expertise, and unwavering dedication. We prioritize patients' well-being, offering personalized attention and state-of-the-art facilities. From preventive care to recovery, our team empowers patients with knowledge and support, ensuring they feel heard and valued every step of the way. With a focus on innovation and excellence, we set new standards in healthcare, striving to make world-class treatment accessible and affordable. Experience the difference at RAK Hospital, where your health, comfort, and happiness are our utmost priority. Trust us to accompany you on your journey to wellness with care that truly matters.</p>
                    </div>
                </div>
    ...
    <section class="servicesec">
        <div class="container">
            ...
            <div class="row row-cols-1 row-cols-md-3 g-4">
                <div class="col">
                    <div class="card">
                        <img src="<?php echo BASE_URL ?>assets/images/service1.avif" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Patient and Family Rights &
                                Responsibilities</h5>
                            <p class="card-text">We respect the rights of all patients and their families, we believe
                                that patient care is greatly improved when patinets (and families) are involved</p>
                            <a href="RakInternationalPatientService.php">Know more <i class="fa-solid fa-angle-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card">
                        <img src="<?php echo BASE_URL ?>assets/images/service2.avif" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Patient Education</h5>
                            <p class="card-text">We respect the rights of all patients and their families, we believe
                                that patient care is greatly improved when patinets (and families) are involved</p>
                ...
                <div class="col">
                    <div class="card">
                        <img src="<?php echo BASE_URL ?>assets/images/service3.avif" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Hospitality Services</h5>
                            <p class="card-text">We respect the rights of all patients and their families, we believe
                                that patient care is greatly improved when patinets
                                (and families) are involved</p>
                            <a href="#">Know more <i class="fa-solid fa-angle-right"></i></a>
                        </div>
                    </div>
                </div>
    ...
    <section class="rasaisec" style="background-color:#fff;">
        ...
        <div class="button-doctor">
            <a class="btn-submit" href="#"> Know more <img src="<?php echo BASE_URL ?>assets/images/arrow-right.png" alt=""> </a>
        </div>
